...
The IRSR Subtheme is a Stanford sub-theme that works with the Stanford Basic theme and was built by modifying the [Stanford Starter](https://github.com/SU-SWS/stanford_starter) Subtheme.
...
3. Change all theme file names from including "ppo_irsr_subtheme" to including the machine name of your theme.
4. Run a search and replace throughout the theme files to replace "ppo_irsr_subtheme" with the machine name of your theme.
